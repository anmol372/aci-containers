...
import (
	...
	"github.com/noironetworks/aci-containers/pkg/networkpolicy/clientset/versioned/scheme"
...
// AciV1Client is used to interact with features provided by the aci.netpol group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) NetworkPolicies() NetworkPolicyInterface {
